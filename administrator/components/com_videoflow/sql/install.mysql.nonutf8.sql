...
CREATE TABLE IF NOT EXISTS `#__vflow_conf` (
  ...
  `appname` text,
  `canvasurl` text,
  `jtemplate` varchar(150) NOT NULL default 'default',
  `ftemplate` varchar(150) NOT NULL default 'default',
  ...
  `mediadir` varchar(150) NOT NULL default 'videoflow',
  `commentsys` varchar(150) default NULL,
  `mootools12` tinyint(1) NOT NULL default '1',
  `lightbox` tinyint(1) NOT NULL default '1',
  `lightboxsys` varchar(150) default NULL,
  ...
  `toolcolour` varchar(150) NOT NULL default 'grey',
  `player` varchar(150) NOT NULL default 'nonverblaster',
...
CREATE TABLE IF NOT EXISTS `#__vflow_plugins` (
  ...
  `name` tinytext,
  `jname` text,
  `propername` varchar(150) default NULL,
  `type` text,
  PRIMARY KEY  (`pid`)
) ENGINE=MyISAM  AUTO_INCREMENT=1 ;
...
(1, 'grid', 'Grid', 'template', 'Displays media files in grid format', 'Joomla', 0),

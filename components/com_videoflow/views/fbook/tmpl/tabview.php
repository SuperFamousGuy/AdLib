...
<div id="vfwrapper" style="width:520px;">
...
//Set default preview image, correcting for earlier versions where files name was saved as full URL
    ...
    if ($media->server == 'youtube') $vheight = '290'; else $vheight = '265';
...
<tr><td>
<div style="overflow: visible; border: none; float:left; margin-right:10px; padding-right:10px; padding-bottom:20px;"> 
<center>
...
<?php
echo $media->embedcode;
} else {
echo '<fb:swf swfsrc="'.$media->embedcode['player'].'" flashvars="'.$media->embedcode['flashvars'].'" width="470px" height="'.$vheight.'" imgstyle="width: 120px; height: 90px;" waitforclick="true" imgsrc="'.$pixlink.'"/>';
}
?>
</center>
</div>
...
<table cellspacing="0" cellpadding="0" style="float:right; width:70%">
<tr><td>
...
<?php
if ($vparams->showpro && $vparams->fbshowmylist){
?>

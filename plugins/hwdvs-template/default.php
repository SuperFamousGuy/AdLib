...
$smartyvs->assign("templateDirectoryUrl", $templateDirectoryUrl);
$lang = JFactory::getLanguage();
if($doc->getType() == 'html')
{
	if ($lang->isRTL()) 
        {
		$doc->addCustomTag('<link rel="stylesheet" href="'.$templateDirectoryUrl.'template_rtl.css" type="text/css" />');
		$doc->addCustomTag('<link rel="stylesheet" href="'.$templateDirectoryUrl.'css/rating_rtl.css" type="text/css" />');
	} 
        else 
        {
...
if ($lang->isRTL())
{
	$css = "#hwdvs_navcontainer { width: ".$nav_width."px;}
        ...
        #hwdvids .menudo_image {
                background:transparent url('".$templateDirectoryUrl."images/search_bar_rtl.png') no-repeat scroll 0px 0px;
        }";
}
else
{

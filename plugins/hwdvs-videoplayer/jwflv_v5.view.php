...
class hwd_vs_videoplayer {
	...
	{
		global $task, $smartyvs, $option, $Itemid, $show_longtail, $longtail_c, $j15, $j16, $playerSwf;
	...
	{
		global $task, $smartyvs, $option, $task, $Itemid, $show_longtail, $longtail_c, $j15, $j16, $playerSwf;
		$c = hwd_vs_Config::get_instance();
	...
	{
		global $Itemid, $task, $mosConfig_sitename, $option, $j15, $j16, $hwdvsItemid, $playerSwf;
		$c = hwd_vs_Config::get_instance();
...
<embed src=&#34;".$playerSwf."&#34; type=&#34;application/x-shockwave-flash&#34; allowscriptaccess=&#34;always&#34; allowfullscreen=&#34;true&#34; width=&#34;".$getFlashVars->param_width."&#34; height=&#34;".$getFlashVars->param_height."&#34; wmode=&#34;transparent&#34; flashvars=&#34;".$flashvars15."&#34;></embed>
	...
	*/
	...
	{
		global $smartyvs, $option, $Itemid, $show_longtail, $longtail_c, $longtail_mediaid, $show_video_ad, $videoplayer, $playerSwf;
		$c = hwd_vs_Config::get_instance();
                $doc = & JFactory::getDocument();
		...
		$code->param_bgcolor = $param_bgcolor;
                ...
                $pos = strpos($flv_url, "http");
		if ($pos === false) {
			$ogvideoLoc = 'http://'.$_SERVER['HTTP_HOST'].$flv_url;
		} else {
			$ogvideoLoc = $flv_url;
		}

                $ogvideo = $playerSwf.'?file='.$ogvideoLoc;
		$doc->setMetaData( 'og:video' , $ogvideo );

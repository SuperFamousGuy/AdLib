    ...
    function youtubeComPrepareVideo($row, $flv_width=null, $flv_height=null, $autostart=null)
	{
		...
		if (!empty($truepath) && $c->playlocal == "1")
		{
			...
			if ($pp_playerVersion == 1)
			{
				...
				$code = "<iframe title=\"YouTube video player\" class=\"youtube-player\" type=\"text/html\" width=\"".$flv_width."\" height=\"".$flv_height."\" src=\"".$protocol."youtube.com/embed/".$videocode."?hd=1&wmode=transparent&modestbranding=1\" frameborder=\"0\"></iframe>";
			}
			else
			{
				...
				$code = "<embed src=\"".$protocol."www.youtube.com/v/".$videocode."&rel=0&fs=1&color1=0x3a3a3a&color2=0x999999&border=0&hd=1&modestbranding=1\" type=\"application/x-shockwave-flash\" wmode=\"transparent\" width=\"".$flv_width."\" height=\"".$flv_height."\" allowfullscreen=\"true\"></embed>";
			}
			return $code;
		}
	}

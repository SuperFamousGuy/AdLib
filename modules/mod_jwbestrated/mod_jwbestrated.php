<?php
/**
 * JWallpapers Best Rated module - A module to display the best rated JWallpapers pictures
 * 
 * @version 1.4 $Id: mod_jwbestrated.php 353 2010-06-01 10:04:20Z amazeika $
 * @package JWallpapers
...
if ($show_more_pics) {
	...
	if ($menu_id) {
		...
		$bestRatedString = JFilterOutput::stringURLSafe ( JText::_ ( 'BEST_RATED' ) );
		$viewMoreLink = 'index.php?option=com_jwallpapers&view=special&id=1:' . $bestRatedString;
	}
